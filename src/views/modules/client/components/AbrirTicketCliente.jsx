...
const AbrirTicketCliente = () => {
    ...
    const { tickets, updateExistingTicket } = useFetchTickets();
    ...
    const handleUpdateTicket = async () => {
        ...
        //Actualiza el ticket
        await updateExistingTicket(ticket.id, ticketData);
        ...
        if (mensaje.trim()) {
            ...
            console.log("Enviando mensaje:", nuevoMensaje); // Verifica el contenido del mensaje
    ...
    const handleEditorChange = (event, editor) => {
        ...
        setMensaje(data); // Guardar el contenido del editor en el estado de mensaje
    };
    ...
    const cliente = clientes.find(c => c.id === ticket.id_cliente);
    const agente = agentes.find(a => a.id === ticket.id_agente);
    const sede = sedes.find(s => s.id === ticket.id_sede);
            ...
            <div className="flex flex-1">
                ...
                <div className="w-3/8 p-8 bg-white border border-gray-200 min-h-[74vh]">
                    <div className="mb-4">
                        ...
                        <input
                            type="text"
                            value={cliente ? cliente.nombre_completo : 'Cargando...'}
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            type="text"
                            value={agente ? agente.nombre : 'Cargando...'}
                            className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
                            readOnly
                        />
                    </div>
...
export default AbrirTicketCliente;