...
import LoginImg from "../../../../assets/img/login_agentes.jpg";
...
export const LoginAgent = () => {
  ...
  const { startAgenteLogin } = useAuthStore();
  ...
  useEffect(() => {
    ...
    // console.log("Status de agentes", status);
  ...
  const onSubmit = async (e) => {
    ...
    try {
      await startAgenteLogin({ email, password });
    } catch (error) {
