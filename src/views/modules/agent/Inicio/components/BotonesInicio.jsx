const BotonesInicio = ({ setTipoTicket, openTicketsCount, resolvedTicketsCount }) => {
    return (
      <div className="flex justify-between items-center mb-6 mt-8">
        <div className="flex flex-col">
          ...
          <div className="flex space-x-0">
            ...
            >
              <span className="font-bold">{openTicketsCount}</span>
            ...
            >
              <span className="font-bold">{resolvedTicketsCount}</span>
