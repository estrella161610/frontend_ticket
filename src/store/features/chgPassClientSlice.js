...
//Ación para cambiar la contraseña del cliente
export const changePassword =  createAsyncThunk(
    'auth/changePassword',
    async ({password, new_password, new_password_confirmation}, {rejectWithValue}) => {
        try{
            const response = await axiosClient.put("/cliente/password", {
                password: password,
...
const chgPassClientSlice = createSlice({
    name: 'password',
    initialState: {
        message: null,
        isLoading: false,
...
export default chgPassClientSlice.reducer;