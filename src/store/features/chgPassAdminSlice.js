...
//Ación para cambiar la contraseña del admin
export const changePassword =  createAsyncThunk(
    'auth/changePassword',
    async ({password, new_password, new_password_confirmation}, {rejectWithValue}) => {
        try{
            const response = await axiosClient.put("/admin/password", {
                password: password,
...
const chgPassAdminSlice = createSlice({
    name: 'password',
    initialState: {
        message: null,
        isLoading: false,
...
export default chgPassAdminSlice.reducer;