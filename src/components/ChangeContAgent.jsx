...
import useChgPassAgent from "../hooks/useChgPassAgent";
import { useAuthStore } from "../hooks/useAuthStore";

const ChangeContAgent = ({ isOpen, onClose }) => {
  ...
  //Hooks
  const { error: cambioError, handleChangePassword } = useChgPassAgent();
...
export default ChangeContAgent;
