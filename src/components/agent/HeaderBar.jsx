...
import { FaBell, FaUserCircle, FaDove, FaTimes, FaTicketAlt, FaUserFriends } from "react-icons/fa";
...
const HeaderBar = () => {
  ...
  const { perfil, isLoading: loadingPerfil, error: errorPerfil } = useFetchPerfilAgente();
