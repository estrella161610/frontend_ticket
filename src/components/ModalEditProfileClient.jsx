...
const ModalEditProfileClient = ({ isOpen, onClose, onSubmit, perfil }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white p-6 rounded-lg shadow-lg z-10 w-full max-w-lg">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mt-8">
                        {/* <label className="block mt-2 font-semibold">Nombre Completo</label>
                        <input
                            type="text"
                        ...
                        <label className="block mt-2 font-semibold">Nombre Corto</label>
                        <input
                            type="text"
                            name="nombre_corto"
...
export default ModalEditProfileClient